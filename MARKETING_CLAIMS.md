...
| الأسعار 299 / 749 / 1200 جنيه (شهر / 3 شهور / 6 شهور) | قرار تجاري من صاحب المنتج (مش في الكود). المصدر الوحيد على الصفحة: `src/lib/seo.js` (`PLANS`) — أي تغيير يتم من هناك |
...
| الموضوع | التفاصيل |
|---|---|
| سعر الاشتراك في رسالة الأدمن | كانت رسالة تجديد الاشتراك في `src/pages/admin/AdminDashboard.jsx` مكتوب فيها «تبدأ من 99 جنيه/شهر» بينما صفحة الأسعار 299. **اتصلحت**: الرسالة بقت بتاخد الرقم من `PLANS[0].price` في `src/lib/seo.js` (نفس مصدر صفحة الأسعار)، فمينفعش تتعارض تاني. |
